...
const allowedAdminEmail = "leonardudoh5@gmail.com";
const password = process.env.ADMIN_PASSWORD;
const fullName = process.env.ADMIN_NAME || "LeonardX Admin";
if (email && email.toLowerCase() !== allowedAdminEmail) { console.error("ADMIN_EMAIL must be leonardudoh5@gmail.com"); process.exit(1); }
